...
export default function App() {
  ...
  const [form, setForm] = useState({
    ...
    donch_use_filter: false,
    donch_adx_period: 14,
    donch_adx_threshold: 20,
    donch_vol_period: 20,
    donch_vol_mult: 1.1,
    donch_atr_period: 14,
    donch_atr_stop_mult: 2.5,
    donch_atr_target_mult: 8.0,
    rsi_period: 14,
    rsi_oversold: 30,
    rsi_overbought: 70,
    macd_fast: 12,
    macd_slow: 26,
    macd_signal: 9,
    macd_use_filter: false,
    macd_filter_ma_period: 200,
    stop_type: 'pct',
    stop_pct: 0.08,
    atr_period: 14,
    atr_mult: 2.0,
  ...
  const numericKeys = [
    ...
    'donch_adx_period', 'donch_adx_threshold', 'donch_vol_period', 'donch_vol_mult',
    'donch_atr_period', 'donch_atr_stop_mult', 'donch_atr_target_mult',
    'rsi_period', 'rsi_oversold', 'rsi_overbought',
    'macd_fast', 'macd_slow', 'macd_signal', 'macd_filter_ma_period',
