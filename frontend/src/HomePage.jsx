...
const STRATEGY_INTRO = [
  ...
  { name: 'ATR 通道突破', desc: '用波動度（ATR）畫出通道取代固定百分比，通道寬度會隨市場震盪程度自動縮放。' },
  { name: 'FVG 缺口回補', desc: '偵測連續三根K棒間的價格缺口，等回測缺口出現反轉確認才進場，出場靠ATR停損停利。' },
  { name: '轉折突破', desc: '突破經確認的轉折高低點就翻單，沒有濾網沒有停損，靠反向訊號直接反手，理論上永遠有部位。' },
  { name: 'MA60季線濾網', desc: '站上60日均線且大方向偏多（收盤在200日均線之上）才進場，只做多，規則最單純、交易次數少。' },
